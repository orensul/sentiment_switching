...
def get_content_preservation_score(actual_word_lists, generated_word_lists, embedding_model):
    ...
    for word_list_1, word_list_2 in zip(actual_word_lists, generated_word_lists):
        ...
        try:
            cosine_similarity = 1 - cosine(get_sentence_embedding(words_1, embedding_model),
...
def run_content_preservation_evaluator(source_file_path, target_file_path, embeddings_file):
    ...
    content_preservation_score = get_content_preservation_score(actual_word_lists, generated_word_lists, glove_model)
    word_overlap_score = get_word_overlap_score(actual_word_lists, generated_word_lists)
