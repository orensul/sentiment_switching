...
from sentiment_switching_model.visualizers import tsne_visualizer
...
def generate_plot_coordinates(label_mapped_embeddings, coordinates_path, index_to_labels, plot_path, fig_num):
    ...
    coordinates = TSNE(n_components=2).fit_transform(X=embeddings) if embeddings.shape[1] != 2 else embeddings
